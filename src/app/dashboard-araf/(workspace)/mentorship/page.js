...
import MentorshipEditor from "@/components/dashboard/MentorshipEditor";
...
export default async function DashboardMentorshipPage() {
  const content = await readMentorshipContentFromSupabase();
  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-4 py-6 sm:px-6 sm:py-8">
      ...
      <MentorshipEditor initialContent={content} />
    </main>
  );
}
