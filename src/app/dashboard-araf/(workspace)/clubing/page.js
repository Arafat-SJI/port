...
import ClubingEditor from "@/components/dashboard/ClubingEditor";
import { readClubingContentFromSupabase } from "@/lib/clubingContentServer";

export default async function DashboardClubingPage() {
  const content = await readClubingContentFromSupabase();
  ...
  return (
    <main className="mx-auto w-full max-w-5xl px-4 py-6 sm:px-6 sm:py-8">
      ...
      <ClubingEditor initialContent={content} />
    </main>
  );
}
