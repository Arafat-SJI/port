            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0">
                <div className="flex items-start justify-between gap-2 mb-1">
                  <h3 className="text-sm font-semibold text-on-surface leading-snug">{award.title}</h3>
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">{award.description}</p>
              </div>
            </div>
          </div>
        ))}
